package nitchcorp.backend.titan.shared.minio.service.impl;
...
import nitchcorp.backend.titan.shared.minio.exception.FileNotFoundException;
import nitchcorp.backend.titan.shared.minio.exception.InvalidFileTypeException;
import nitchcorp.backend.titan.shared.minio.exception.MinioException;
import nitchcorp.backend.titan.shared.minio.service.MinioService;
import nitchcorp.backend.titan.shared.minio.config.MinioProperties;
    ...
    private void ensureBucketExists(String bucketName) {
        try {
            ...
            if (!exists) {
                ...
                // Configure public access for image and photo buckets
                if (bucketName.equals(minioProperties.getBucket().getImages()) ||
                    bucketName.equals(minioProperties.getBucket().getPhotos())) {
